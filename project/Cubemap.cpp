...
void Cubemap::RootSignature() {
	...
	rootParameters[2].DescriptorTable.pDescriptorRanges = descriptorRange;//Object3d.VS.hlsl の b0
	rootParameters[2].DescriptorTable.NumDescriptorRanges = _countof(descriptorRange);//Object3d.VS.hlsl の b0
...
void Cubemap::GraphicsPipeline() {
	...
	//shaderのコンパイラ
	Microsoft::WRL::ComPtr<IDxcBlob> vertexShaderBlob = dxCommon_->CompileShader(L"resource/shaders/Skybox.VS.hlsl", L"vs_6_0");
	assert(vertexShaderBlob != nullptr);

	Microsoft::WRL::ComPtr<IDxcBlob> pixelShaderBlob = dxCommon_->CompileShader(L"resource/shaders/Skybox.PS.hlsl", L"ps_6_0");
